...
export function PostCardApi({
  ...
  return (
    <article className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-200 hover:border-green-200 hover:shadow-md">
      <div className="p-6">
        <div className="mb-3 flex items-start justify-between">
          <h3 className="line-clamp-1 font-semibold text-gray-900 text-lg group-hover:text-green-600">
            {post.name}
          </h3>
        ...
        <div className="mt-4 flex items-center justify-between border-gray-100 border-t pt-4">
          <button
            className="font-medium text-green-600 text-sm transition-colors hover:text-green-700"
            onClick={() => onView(post)}
            type="button"
          >
            Read more
